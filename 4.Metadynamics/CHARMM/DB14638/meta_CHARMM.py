...
colvar {
	...
	distance {
		...
		group2 { atomNumbersRange 4646-4677 }   #ligante 
	}
}
...
metadynamics {
	...
	#saveFreeEnergyFile on             # Keep all the PMF files Activating this option can be useful to follow more closely the convergence of the simulation, by comparing PMFs with small time
...
colvar {
	...
	angle {
		group1 { atomNumbersRange 2234-2244 }    #CYS 145
		group2 { atomNumbers 4659 4660 4664 4665 4666 4677 }    #ligante próximos a CYS145
		group3 { atomNumbersRange 4646-4723 }    #ligante
		#CYS145 - lig proximo CYS145 - CG lig
	}
}
...
colvar {
	...
	width  1 #tamanho da gride
	distance {
		group1 { atomNumbersRange 2234-2244 }   #CYS 145 proteina
		group2 { atomNumbersRange 4646-4677 }   #ligante 
	}
}
...
colvar {
	...
	width  10 #10 em 10 graus
	dihedral {
		group1 { atomNumbers 4660 4665 4666 4677 }    
		group2 { atomNumbers 4659 4664 }   
		group3 { atomNumbersRange 4646-4651 atomNumbersRange 4656-4658 atomNumbersRange 4674-4676 atomNumbersRange 4667-4670 atomNumbersRange 4661-4662 }    
		group4 { atomNumbersRange 4652-4655 atomNumbersRange 4671-4673 atomNumbers 4663 }    
	}
}
...
"""
parm3_h.write(content)
parm3_h.close()

config3 = "metadin3.conf"
...
content = """
	...
	coordinates        ../complex_ion.pdb
	set temperature    300
	set outputname     complex_metadin3
	firsttimestep      0
...
namdcommand = "charmrun namd2 ++local +p${NCPUS} metadin3.conf"
os.system(namdcommand)

print("Finalizada CV3")
'''